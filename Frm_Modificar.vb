...
Public Class Frm_Modificar
    ...
    Function Modificar_Registro(ByVal Matricula As String, ByVal Nombre As String, ByVal Direccion As String, ByVal Edad As String, ByVal DNI As String, ByVal CUIT As String, ByVal Telefono As String, ByVal Mail As String) As Boolean
        'convertir
        ...
        CadenaSQL = CadenaSQL + " dni             = '" & Doc & "',"
        CadenaSQL = CadenaSQL + " cuit            = '" & CUIT & "',"
        CadenaSQL = CadenaSQL + " telefono        = '" & Tel & "',"
        CadenaSQL = CadenaSQL + " mail            = '" & Mail & "'"
        CadenaSQL = CadenaSQL + " WHERE matricula = " & Cod
    ...
    Private Sub Text_Nombre_KeyPress(sender As Object, e As KeyPressEventArgs)
        'este método se ejecuta cada vez que el usuario presiona tecla enter, estando el foco en text_nombre
        If Asc(e.KeyChar) = 13 Then
            Text_Direccion.Focus()
        End If
    End Sub

    Private Sub Text_Direccion_KeyPress(sender As Object, e As KeyPressEventArgs)
        'este método se ejecuta cada vez que el usuario presiona tecla enter, estando el foco en text_nombre
        If Asc(e.KeyChar) = 13 Then
            Text_Edad.Focus()
        End If
    ...
    Private Sub Text_Edad_KeyPress(sender As Object, e As KeyPressEventArgs)
        'este método se ejecuta cada vez que el usuario presiona tecla enter, estando el foco en text_nombre
        If Asc(e.KeyChar) = 13 Then
            Text_DNI.Focus()
        End If
    ...
    Private Sub CMB_Buscar_Click_1(sender As Object, e As EventArgs) Handles CMB_Buscar.Click
        If Buscar_Registro(Text_Matricula.Text) = False Then
            'mostrar los datos cuando el registro existe
    ...
    Private Sub CMB_Guardar_Click_1(sender As Object, e As EventArgs) Handles CMB_Guardar.Click
        Modificar_Registro(Text_Matricula.Text, Text_Nombre.Text, Text_Direccion.Text, Text_Edad.Text, Text_DNI.Text, Text_CUIT.Text, Text_Telefono.Text, Text_Mail.Text) 'modifica los datos en la BBDD
